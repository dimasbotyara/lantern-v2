...
class ChatListSidebar(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self._user_name_label.setContentsMargins(0, 0, 0, 0)
        self._user_name_label.setStyleSheet("padding: 0; margin: 0;")
        ...
        self._user_status_label.setContentsMargins(0, 0, 0, 0)
        self._user_status_label.setStyleSheet("padding: 0; margin: 0;")
        ...
        self._status_btn.setFont(QFont(get_font_family("emoji"), 12))
        ...
        self._new_chat_btn.setFont(QFont(get_font_family("ui"), 24))
